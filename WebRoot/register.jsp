...
function checkregisterform()
{
	...
	if (document.getElementById('zhuanyeid').value=="")
	{
		alert("专业不能为空");
		return false;
	}
	
	if (document.getElementById('banjiid').value=="")
	{
		alert("班级不能为空");
		return false;
	}
...
function createQueryStringregister(){
	...
	var zhuanye = encodeURI(encodeURI($("#zhuanyeid").val()));
	var banji = encodeURI(encodeURI($("#banjiid").val()));
			...
			<table align="center">
				...
				<table align="center" border="1" cellpadding="5" cellspacing="3">
					...
					<tr>
						...
						<td>
							<input type="text" name="banji" style="width: 250px;" id="banjiid" />
						</td>
					</tr>
